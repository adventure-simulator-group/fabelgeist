...
generate-procedural-equipment output:
    @cargo run --release --manifest-path crates/adventuresim-character-creator/Cargo.toml -- --generate-equipment --lod 4 --recipe assets_src/characters/mhr_base.json --equipment-output {{ quote(output) }}
