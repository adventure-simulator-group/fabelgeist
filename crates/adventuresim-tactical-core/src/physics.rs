...
use bevy::prelude::*;
use bevy_ahoy::{
    CharacterController, CharacterControllerState, CharacterLook, input::AccumulatedInput,
};
...
mod plugin;
pub use plugin::{AdventureSimulatorPhysicsPlugin, AdventureSimulatorPhysicsSet};
