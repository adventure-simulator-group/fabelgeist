    ...
    STUDIES.get_or_init(|| {
        serde_json::json!([
            ...
            serde_json::from_str::<Value>(include_str!("../review/museum/cma-1916.1589.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/khm-a297.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/met-29.158.674.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/khm-a287.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/met-14.25.1096.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/cma-1916.686.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/met-96.5.23.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/met-08.261.2.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/met-14.25.116.json"))
                .expect("museum study catalog must be valid JSON"),
            serde_json::from_str::<Value>(include_str!("../review/museum/met-14.25.259.json"))
                .expect("museum study catalog must be valid JSON")
        ])
    })
}
