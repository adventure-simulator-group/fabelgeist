...
9,000 pair cases). Mace proposals whose plates cannot fit their receiving core
faces must return explicit diagnostics and no mesh; independent geometric
witnesses check these rejections. Default presets must always remain valid.
The same structural validator covers every haft/head
